...
public class TriangleCheckerTest {
	...
	public void checkScaleneTriangleTest() {
		...
		TriangleType scaleneTriangle = scaleneTriangleChecker.checkTriangle(3,2,4);
		assertEquals(TriangleType.SCALENE_TRIANGLE, scaleneTriangle);
		scaleneTriangle = scaleneTriangleChecker.checkTriangle(1,3,5);
		assertEquals(TriangleType.SCALENE_TRIANGLE, scaleneTriangle);
		scaleneTriangle = scaleneTriangleChecker.checkTriangle(2,1,7);
		assertEquals(TriangleType.SCALENE_TRIANGLE, scaleneTriangle);
	}
